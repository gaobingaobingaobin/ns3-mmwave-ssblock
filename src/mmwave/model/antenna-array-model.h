...
private:
	...
	// Carlos modification
//	std::map <Ptr<NetDevice>, complexVector_t> m_enbCodebooks;	// Codebooks of all the enBs
//	std::map <Ptr<NetDevice>, complexVector_t> m_ueCodebooks;		// Codebooks of all the UEs
	// End of modification
